...
mod search_test {
    ...
    fn test_position_alpha_beta(fen: &str, depth: u8) -> String {
    ...
    fn queen_take_white_alpha_beta() {
        ...
        for depth in 1..3 {
            let found_move = test_position_alpha_beta(fen, depth);
    ...
    #[test]
    fn mate_in_three() {
        let found_move = test_position_alpha_beta("4r2k/pp4pp/3Q1b2/1n6/4pN2/B3PqP1/5P2/6KR w - - 0 35", 4);
        assert_eq!(found_move, "f4g6");
    }

    #[test]
    fn find_best_move() {
        let found_move = test_position_alpha_beta("8/1p3p2/1P2bk2/5p1p/P7/2pB3P/5PP1/5K2 b - - 1 31", 5);
        assert_eq!(found_move, "e6c4");
    }

    #[test] 
    fn find_best_move_2() {
        let found_move = test_position_alpha_beta("4r1k1/5pp1/1ppR2qp/4P3/1P6/2P5/P3Q1PP/6K1 b - - 1 25", 4);
        assert_eq!(found_move, "g6d6");
    }

    #[test]
    fn find_best_move_3() {
        let found_move = test_position_alpha_beta("7k/6p1/6Qp/pp1p4/2p5/q1P4P/2P1r1P1/5R1K w - - 0 32", 4);
        assert_eq!(found_move, "f1f7");
    }

    #[test]
    fn find_best_move_4() {
        let found_move = test_position_alpha_beta("r4rk1/ppp1nppp/n3b3/1N1p4/2PP4/1Q1BqN2/PP4PP/R4R1K w - - 2 13", 4);
        assert_eq!(found_move, "d3h7");
    }

    #[test]
    fn find_best_move_5(){
        let found_move = test_position_alpha_beta("6r1/p3kp2/1p2p2p/2rn2q1/3R4/5P2/P1P1B2P/3R1Q1K w - - 12 34", 4);
